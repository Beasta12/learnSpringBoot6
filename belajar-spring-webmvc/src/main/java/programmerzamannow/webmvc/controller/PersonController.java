...
public class PersonController {
    ...
    public ResponseEntity<String> createPerson(@ModelAttribute @Valid CreatePersonRequest request,
        ...
        String response = new StringBuilder().append("Success create person ")
                ...
                .append("with city ").append(request.getAddress().getCity()).append(" ")
                .append("with country ").append(request.getAddress().getCountry()).append(" ")
                .append("with postalCode ").append(request.getAddress().getPostalCode())
                .toString();
